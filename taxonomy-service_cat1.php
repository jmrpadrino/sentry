                ...
                <div class="row gray-fondo">
                    ...
                    <div class="col-sm-9 content-wrapper">
                        ...
                        <?php
                            ...
                            }else{ //END verify if have children terms
                                    if( have_posts() ){
                                        while ( have_posts() ){ the_post();
                        ?>
                        <article>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-sm-8">
                                    <p class="sorry-not-found"><?php _e('There are no items in this category. Maybe a search can help.', 'sentrywellheadsystems'); ?></p>
                                    <div class="hidden-xs">
