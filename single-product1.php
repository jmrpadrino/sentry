...
?>
    ...
    <main>
        <div class="container">
            <div class="row gray-fondo">
                ...
                <div class="col-sm-9 content-wrapper">
                    ...
                    <div class="col-md-12 text-center">
                        <?php echo the_post_thumbnail('full', array( 'id' => 'featured_image', 'class' => 'img-responsive')); ?>
                    </div>
                    <?php } ?>
                    <div class="col-md-12 hidden-xs desktop-slider">
                        <?php
                            $images = get_post_meta($post->ID, $prefix.'gallery', false);
                            if (count ($images) > 0){
                                echo '<div id="slider" class="single-slider">';
                                foreach ($images as $image){
                                    $image_url = wp_get_attachment_url( $image );
                                    $image_thumb_url = wp_get_attachment_thumb_url( $image );
                                    echo '<div id="item-slider" class="slider-item" data-img="' . $image_thumb_url . '">';
                                    echo '<div class="slider-item-mask"></div>';
                                    echo '<img src="' . $image_thumb_url . '" alt="" class="img-responsive">';
                                    echo '</div>';
                                }
                                echo '</div>';
                            }
                    ...
                    <div class="col-md-12 visible-xs responsive-slider">
                        <?php
                            $images = get_post_meta($post->ID, $prefix.'gallery', false);
                            if (count ($images) > 0){
                                echo '<div id="sliderResponsive" class="">';
                                foreach ($images as $image){
                                    $image_url = wp_get_attachment_url( $image );
                                    $image_thumb_url = wp_get_attachment_thumb_url( $image );
                                    echo '<div id="item-slider" class="slider-item" data-img="' . $image_thumb_url . '">';
		    ...
		    <?php
                                echo '<h3 class="single-product-description">Description</h3>';
                                echo $product_meta;
		    ?>
		    </div>
		    <?php 
                    ...
                    <div class="col-md-6 post-meta-wrapper">
                        <?php
                            ...
                            if (!empty($product_meta)){
                                echo '<h3 class="single-product-feartures">Features/Benefits</h3>';
                                echo $product_meta;
                            }
                        ?>
                    </div>
		    <div class="col-md-12">
                        ...
                        <?php
                            ...
                            if (!empty($product_meta)){
                                ...
                                echo '<p class="single-product-short-description paragraph">'.$product_meta.'</p>';
                                echo '</div>';
                            }
                        ?>
