        ...
        <section>
            <div class="container">
                <div class="row gray-fondo">
                        ...
                        <aside>
                            ...
                            <?php
                                ...
                                foreach( $terms as $term_item ){
                                    ...
                                    $products_side_list = new WP_Query( $args );
                                    if ($products_side_list->have_posts()){ $item_counter = 0;
                                        echo '<ul id="parent-'.$term_item->term_id.'"class="children-list">';
                                        while ($products_side_list->have_posts()){ $products_side_list->the_post();
                                            echo '<li class="child-item">';
                                            echo '<a class="child-link" href="';
                                            the_permalink();
                                            echo '">';
                    ...
                    <?php
                        $termino = get_term_by('slug', $term, 'type');
                        if ($termino->parent == 0){ 
                    ?>
